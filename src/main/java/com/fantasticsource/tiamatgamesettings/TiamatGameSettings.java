...
@Mod(modid = TiamatGameSettings.MODID, name = TiamatGameSettings.NAME, version = TiamatGameSettings.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.044,)", acceptableRemoteVersions = "*")
